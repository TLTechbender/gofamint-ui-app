...
// const infiniteSermonQueryFunction = async ({
//   start,
//   end,
//   searchTerm,
// }: {
...
//   // Fixed logic: Check if we've fetched fewer items than requested (meaning we're at the end)
//   // OR check if start + actual items fetched < total count
//     console.log(end);
...
//     useInfiniteQuery({
//       queryKey: ["infinite", "sermons", searchTerm], // More descriptive key
//       queryFn: ({ pageParam = 1 }) => {
