...
// import { MessageCircle, Share2, Clock, Eye } from "lucide-react";
...
//                 onError={() =>
//                   console.error("Failed to load image:", value.asset)
//                 }
//               />
//             </div>
//           </figure>
...
//           .url();
//       }
//       return "/api/placeholder/48/48"; // Fallback image
//     } catch (error) {
...
//       return null;
//     } catch (error) {
//       console.error("Failed to generate featured image URL:", error);
//       return null;
//     }
//   };
...
//     } catch (error) {
//       console.error(`Failed to get ${platform} social link:`, error);
//       return null;
//     }
//   };
...
//   const authorDetails = {
//     profilePictureUrl: urlFor(blogPost.author.profilePic!.asset)
//       .width(100)
//       .height(100)
//       .quality(80)
//       .format("webp")
//       .url(),
//     isTheCommentingUserTheAuthor: blogPost.author.userId! == data?.user.id,
//   };
...
//   console.log(isBlogIdLoading);
//   console.log(isBlogIdError);
...
//             ? clamp(0.15 * blogPost.readingTime * 60_000, 7_000, 60_000)
//             : 5000
...
//                 width={48}
//                 height={48}
//                 onError={() => console.error("Failed to load author image")}
//               />
...
//                 {/* Uncomment when LikePostButton is ready
//                 <LikePostButton
//                   userId={currentUserId}
//                   postId={blogPost._id}
//                   initialIsLiked={isLiked}
//                   initialLikesCount={blogPost.likes?.length || 0}
//                 />
//                 */}
...
//                 }}
//                 className="flex items-center gap-2 text-gray-600 hover:text-black transition-colors text-sm font-light"
//               >
