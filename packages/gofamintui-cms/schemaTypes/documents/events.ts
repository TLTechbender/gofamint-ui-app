...
//       type: 'reference',
//       to: [{ type: 'calendarMonth' }],
//       validation: (Rule) => Rule.required(),
//       description: 'Select which month this event belongs to',
//     }),
//     defineField({
//       name: 'eventDate',
...
//       type: 'object',
//       hidden: ({ parent }) => parent?.eventCategory !== 'special',
//       fields: [
//         defineField({
...
//               type: 'text',
//               rows: 3,
//               hidden: ({ parent }) => !parent?.accommodationAvailable,
//             }),
//             defineField({
...
//               hidden: ({ parent }) => !parent?.mealsIncluded,
//             }),
//             defineField({
//               name: 'dietaryOptions',
...
//     },
//     prepare({ title, eventDate, eventType, venue, media, published }) {
